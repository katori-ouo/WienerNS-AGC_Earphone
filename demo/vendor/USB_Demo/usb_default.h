...
#if ((!USB_MODE_AUDIO_EN) && (!USB_KEYBOARD_ENABLE) && (!USB_MOUSE_ENABLE) &&            \
     (!USB_MODE_CDC_EN) && (!USB_CDC_ENABLE) && (!USB_MASS_STORAGE_ENABLE))
#define STRING_VENDOR L"Telink Semi-conductor Ltd, Co"
...
#define USB_KEYBOARD_POLL_INTERVAL                                                       \
    10 // in ms	USB_KEYBOARD_POLL_INTERVAL < KEYBOARD_SCAN_INTERVAL to ensure PC no
       // missing key
